...
<body>
    <form id="form1" runat="server">
        ...
        <div class="DivIndexItem"><asp:LinkButton ID="lbInvest" runat="server" OnClick="lbInvest_Click">投资（固收）</asp:LinkButton></div>
        <div class="DivIndexItem"><a href="#" onclick="go('Form/FundForm.aspx?OpType=Purchase')">投资（净值）</a></div>
